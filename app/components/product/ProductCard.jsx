...
const ProductCard = ({ image, title, code, onViewDetails }) => {
  return (
    <motion.article
    ...
    >
      ...
      >
        ...
        <div className="px-4 pt-4 pb-3 flex flex-col gap-3">
          ...
          {code && (
            <div className="">
              <span className="flex items-center justify-start gap-2 text-xs text-slate-400 font-medium uppercase tracking-wider">
                Product Code:{" "}
